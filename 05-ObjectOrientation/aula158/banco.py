...
class Banco:
    ...
    def _checa__se_conta_e_do_cliente(self, cliente, conta):
        if conta is cliente.conta:
            print('_checa_conta', True)
            print('_checa__se_conta_e_do_cliente', True)
            return True
        
        print('_checa__se_conta_e_do_cliente', False)
        return True
    ...
    def autenticar(self, cliente: pessoas.Pessoa, conta:contas.Conta):
        return self._checa_agencia(conta) and \
            ...
            self._checa__se_conta_e_do_cliente(cliente, conta)
...
if __name__ == '__main__':
    c1 = pessoas.Cliente('leonardo', 55)
    cc1 = contas.ContaCorrente(111, 222, 0, 0)
    c1.conta = cc1

    c2 = pessoas.Cliente('julia', 22)
